                                ...
                                <section class="base">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" name="id_product" id="id_product" required>
                                            ...
                                            while ($data_product = mysqli_fetch_array($qry_product)) {
                                                $selected = ($data_product['id_product'] == $dt_coupon['id_product']) ? 'selected' : '';
                                                ?>
                                                <option value="<?= $data_product['id_product'] ?>" <?= $selected ?>><?= $data_product['name_product'] ?></option>
                                                <?php
                                            }
                                            ?>
                                        </select>
                                    ...
                                    <div class="mb-3">
                                        <label for="validity" class="form-label">Validity (1 for valid and 0 for
                                            invalid)</label>
                                        <input type="number" name="validity" value="<?= $dt_coupon['is_valid'] ?>"
                                            class="form-control" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="deadline" class="form-label">Deadline</label>
                                        <input type="datetime-local" name="deadline"
                                            value="<?= date('Y-m-d\TH:i:s', strtotime($dt_coupon['deadline'])) ?>"
                                            class="form-control" required>
                                    </div>
                                    <div>
