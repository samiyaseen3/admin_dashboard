        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              ...
              ?>
              <form method="POST" action="../pages/process_update_user.php" enctype="multipart/form-data">
                <section class="base">
                  <div class="mb-3">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" name="mail" value="<?= $dt_user['mail'] ?>" class="form-control">
                  </div>
                  <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Phone</label>
                    <input type="text" name="phone_number" value="<?= $dt_user['phone_number'] ?>" class="form-control">
                  </div>
                  ...
                  <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">User Photo</label>
                    <input type="file" name="file" class="form-control">
                  </div>
                  <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Authority</label>
                    <select name="authority" class="form-select">
                      <option value="1" <?php if ($dt_user['authority'] == 1)
                        echo 'selected="selected"'; ?>>Admin
                      </option>
                      <option value="2" <?php if ($dt_user['authority'] == 2)
                        echo 'selected="selected"'; ?>>Super Admin
                      </option>
                      <option value="3" <?php if ($dt_user['authority'] == 3)
                        echo 'selected="selected"'; ?>>Customer</option>
                    </select>
                  </div>
                  <div>
                    <input type="submit" name="simpan" value="Update User" class="btn btn-primary">
                    <a class="btn btn-warning" href="../pages/user.php">Cancel</a>
                  </div>
                </section>
              </form>
